import {EntryDetailHeaderComponent} from "./entry-detail-header/entry-detail-header.component";
import {EntryDetailMetadataComponent} from "./entry-detail-metadata/entry-detail-metadata.component";
import {EntryTabAuditComponent} from "./entry-tab-audit/entry-tab-audit.component";
...
export * from './entry-detail-metadata/entry-detail-metadata.component';
export * from './entry-tab-audit/entry-tab-audit.component';
